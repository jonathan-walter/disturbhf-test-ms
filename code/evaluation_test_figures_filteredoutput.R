...
eval.flat.negwedge<-getEval(sim.flat.negwedge, which.eval = "filtered")
eval.flat.poswedge<-getEval(sim.flat.poswedge, which.eval = "filtered")
eval.flat.negs<-getEval(sim.flat.negs, which.eval="filtered")
eval.flat.poss<-getEval(sim.flat.poss, which.eval="filtered")
eval.sine.negwedge<-getEval(sim.sine.negwedge, which.eval = "filtered")
eval.sine.poswedge<-getEval(sim.sine.poswedge, which.eval = "filtered")
eval.sine.negs<-getEval(sim.sine.negs, which.eval="filtered")
eval.sine.poss<-getEval(sim.sine.poss, which.eval="filtered")

eval.flat.negwedge.adapt<-getEval(sim.flat.negwedge2, which.eval = "filtered")
eval.flat.poswedge.adapt<-getEval(sim.flat.poswedge2, which.eval = "filtered")
eval.flat.negs.adapt<-getEval(sim.flat.negs2, which.eval="filtered")
eval.flat.poss.adapt<-getEval(sim.flat.poss2, which.eval="filtered")
eval.sine.negwedge.adapt<-getEval(sim.sine.negwedge2, which.eval = "filtered")
eval.sine.poswedge.adapt<-getEval(sim.sine.poswedge2, which.eval = "filtered")
eval.sine.negs.adapt<-getEval(sim.sine.negs2, which.eval="filtered")
eval.sine.poss.adapt<-getEval(sim.sine.poss2, which.eval="filtered")
...
png("~/Box Sync/EstuaryStormResilience/AlgorithmManuscript/figSX_tpr_negative_filt.png",
...
png("~/Box Sync/EstuaryStormResilience/AlgorithmManuscript/hist_recoverror_negative_filt.png",
    units="in", res=300, width=6.5,height=8)
...
png("~/Box Sync/EstuaryStormResilience/AlgorithmManuscript/figSX_fpr_negative_filt.png",
    units="in", res=300, width=6.5,height=8)
