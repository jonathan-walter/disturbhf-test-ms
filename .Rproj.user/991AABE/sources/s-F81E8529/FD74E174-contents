...
for(ii in 1:length(sim.flat.negwedge)){
  ...
  sim.flat.negwedge[[ii]]$empdiff<-mwdistdiffz(testy=testy,refy=refy,wwidth=5/dt, stride=6)
...
saveRDS(sim.flat.negwedge, file="sim_flat_negwedge_20210323_t5.rds")
...
for(ii in 1:length(sim.flat.poswedge)){
  ...
  sim.flat.poswedge[[ii]]$empdiff<-mwdistdiffz(testy=testy,refy=refy,wwidth=5/dt, stride=6)
...
saveRDS(sim.flat.poswedge, file="sim_flat_poswedge_20210323_t5.rds")
...
for(ii in 1:length(sim.flat.negs)){
  ...
  sim.flat.negs[[ii]]$empdiff<-mwdistdiffz(testy=testy,refy=refy,wwidth=5/dt, stride=6)
...
saveRDS(sim.flat.negs, file="sim_flat_negs_20210323_t5.rds")
...
for(ii in 1:length(sim.flat.poss)){
  ...
  sim.flat.poss[[ii]]$empdiff<-mwdistdiffz(testy,refy=refy,wwidth=5/dt, stride=6)
...
saveRDS(sim.flat.poss, file="sim_flat_poss_20210323_t5.rds")
...
for(ii in 1:length(sim.sin.negwedge)){
  ...
  sim.sin.negwedge[[ii]]$empdiff<-mwdistdiffz(testy=testy,refy=refy,wwidth=5/dt, stride=6)
...
saveRDS(sim.sin.negwedge, file="sim_sin_negwedge_20210323_t5.rds")
...
for(ii in 1:length(sim.sin.poswedge)){
  ...
  sim.sin.poswedge[[ii]]$empdiff<-mwdistdiffz(testy,refy=refy,wwidth=5/dt, stride=6)
...
saveRDS(sim.sin.poswedge, file="sim_sin_poswedge_20210323_t5.rds")
...
for(ii in 1:length(sim.sin.negs)){
  ...
  sim.sin.negs[[ii]]$empdiff<-mwdistdiffz(testy=testy,refy=refy,wwidth=5/dt, stride=6)
...
saveRDS(sim.sin.negs, file="sim_sin_negs_20210323_t5.rds")
...
for(ii in 1:length(sim.sin.poss)){
  ...
  sim.sin.poss[[ii]]$empdiff<-mwdistdiffz(testy=testy,refy=refy,wwidth=5/dt, stride=6)
...
saveRDS(sim.sin.poss, file="sim_sin_poss_20210323_t5.rds")
...
for(ii in 1:length(sim.sin.negwedge2)){
  ...
  sim.sin.negwedge2[[ii]]$empdiff<-mwdistdiffz(testy=testy,refy=refy,refwidth=refwidth/dt,wwidth=5/dt, stride=6)
...
saveRDS(sim.sin.negwedge2, file="sim_sin_negwedge_adapt_20210323_t5.rds")
...
for(ii in 1:length(sim.sin.poswedge2)){
  ...
  sim.sin.poswedge2[[ii]]$empdiff<-mwdistdiffz(testy=testy,refy=refy,refwidth=refwidth/dt,wwidth=5/dt, stride=6)
...
saveRDS(sim.sin.poswedge2, file="sim_sin_poswedge_adapt_20210323_t5.rds")
...
for(ii in 1:length(sim.sin.negs2)){
  ...
  sim.sin.negs2[[ii]]$empdiff<-mwdistdiffz(testy=testy,refy=refy,refwidth=refwidth/dt,wwidth=5/dt, stride=6)
...
saveRDS(sim.sin.negs2, file="sim_sin_negs_adapt_20210323_t5.rds")
...
for(ii in 1:length(sim.sin.poss2)){
  ...
  sim.sin.poss2[[ii]]$empdiff<-mwdistdiffz(testy=testy,refy=refy,refwidth=refwidth/dt,wwidth=5/dt, stride=6)
...
saveRDS(sim.sin.poss2, file="sim_sin_poss_adapt_20210323_t5.rds")



## Full tests: flat background, negative wedge
sim.flat.negwedge2<-simDisturb(bkgrnd="flat",disturbtype="neg.wedge",nreps=5000,dist.start=366+refwidth/2)
#plot(sim.flat.negwedge[[1]]$simts, type="l")
...
for(ii in 1:length(sim.flat.negwedge2)){
  ...
  sim.flat.negwedge2[[ii]]$empdiff<-mwdistdiffz(testy=testy,refy=refy,refwidth=refwidth/dt,wwidth=5/dt, stride=6)
...
saveRDS(sim.flat.negwedge2, file="sim_flat_negwedge_adapt_20210323_t5.rds")
...
for(ii in 1:length(sim.flat.poswedge2)){
  ...
  sim.flat.poswedge2[[ii]]$empdiff<-mwdistdiffz(testy=testy,refy=refy,refwidth=refwidth/dt,wwidth=5/dt, stride=6)
...
saveRDS(sim.flat.poswedge2, file="sim_flat_poswedge_adapt_20210323_t5.rds")
...
for(ii in 1:length(sim.flat.negs2)){
  ...
  sim.flat.negs2[[ii]]$empdiff<-mwdistdiffz(testy=testy,refy=refy,refwidth=refwidth/dt,wwidth=5/dt, stride=6)
...
saveRDS(sim.flat.negs2, file="sim_flat_negs_adapt_20210323_t5.rds")
...
for(ii in 1:length(sim.flat.poss2)){
  ...
  sim.flat.poss2[[ii]]$empdiff<-mwdistdiffz(testy=testy,refy=refy,refwidth=refwidth/dt,wwidth=5/dt, stride=6)
...
saveRDS(sim.flat.poss2, file="sim_flat_poss_adapt_20210323_t5.rds")
